...
class Product_lattice_mp_dilution : public Product_lattice_mp{
    public:
    Product_lattice_mp_dilution(int n_atom, int n_variant, double* pi0):Product_lattice_mp(n_atom, n_variant, pi0){}

	Product_lattice_mp_dilution(Product_lattice_mp const &other, int copy_op) : Product_lattice_mp(other, copy_op){}
