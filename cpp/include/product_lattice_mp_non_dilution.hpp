...
class Product_lattice_mp_non_dilution : public Product_lattice_mp, public Product_lattice_non_dilution
{
public:
    ...
    std::string type() const override { return "Model-Parallelism-Non-Dilution"; }
};